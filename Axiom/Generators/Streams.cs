...
namespace Generate
{
    ...
    {
        public static string vMap { get; set; } 
        public static string sMap { get; set; } 
        public static string aMap { get; set; }
        public static string cMap { get; set; } 
        public static string mMap { get; set; }
        public static string mvMap { get; set; } 
        public static string maMap { get; set; } 
        public static string msMap { get; set; }
